...
class SS_Service {
  ...
  factory SS_Service.fromMap(Map<String, dynamic> map) {
    return SS_Service(
      id: map['id'] ?? '',
  ...
  factory SS_Service.fromJson(String source) => SS_Service.fromMap(json.decode(source));
