      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
            ...
            child: appbar.AppBarContents(title: widget.title, scaffoldKey: _scaffoldKey,),
          ),
          // Search bar
          Positioned(
            top: 124,
            ...
            left: 30,
            child: MySearch(
              history : ["Place 1", "Place 2", "Place 3", "Place 4", "Place 5", "Place 6"],
              history_loc : ["Sadar Point", "Jawal Point", "Rajdan Chowk", "Sretha St", "Sadar Point", "Jawal Point"],
              fabFn: fabFn,
        ...
        GestureDetector(
          ...
          child: Row(
            ...
            children: [
              Text(
                widget.history[i],
                style: const TextStyle(fontSize: 20.0, fontWeight: FontWeight.normal, color: Color(0xFF333333), letterSpacing: -0.5),
              ),
              const Spacer(),
              Text(
                widget.history_loc[i],
                style: const TextStyle(fontSize: 11.0, fontStyle: FontStyle.italic, color:Color(0xFF333333), letterSpacing: -0.5),
              ),
            ],
          ),
        )
        ...
        children: [
          SizedBox(
            ...
            child: TextField(
                ...
                style: const TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color:  Color(0xFF333333), letterSpacing: -0.5),
                ...
                suffixIcon: IconButton(
                  ...
                  hintText: "Search...",
                  hintStyle: const TextStyle(fontSize: 20.0, fontWeight: FontWeight.normal, color: Color(0xFFD1D1D1), letterSpacing: -0.5),
                ),
                onTap: _extend,
