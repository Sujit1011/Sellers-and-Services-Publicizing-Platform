...
class ServiceProfilePage extends StatefulWidget {
  ...
  const ServiceProfilePage({Key? key, required this.rating, required this.shopName, required this.joined, required this.reviews, required this.contacted, required this.aboutUs}) : super(key: key);
      ...
      body: Stack(
        children: <Widget>[
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Column(children: [
                                              ...
                                              Text(widget.joined.toString(), style: Theme.of(context).textTheme.headline4),
                                            ],),
                                            const Spacer(),
                                            ...
                                            Column(children: [
                                              ...
                                              Text(widget.reviews.toString(), style: Theme.of(context).textTheme.headline4),
                                            ],),
                                            const Spacer(),
                                            const VerticalDivider(
                                              width: 42,
                                            ...
                                            Column(children: [
                                              ...
                                              Text(widget.contacted.toString(), style: Theme.of(context).textTheme.headline4),
                                            ],),
                                            const Spacer(),
                                          ],
                                        ),
                                ...
                                //   height: 200,
                                  children: [
                                    Row(
                                      children: [
                                        const Spacer(),
                                        Expanded(flex: 3, child: Text("Service 1", style: Theme.of(context).textTheme.headline5)),
                                        const Spacer(),
                                        Expanded(flex: 1, child: Text("₹50", style: Theme.of(context).textTheme.headline5, textAlign: TextAlign.end,)),
                                        const Spacer(),
                                      ],
                                    ),
                                    const Divider(
                                            ...
                                            SizedBox(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: LinearProgressIndicator(
                                                  ...
                                                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFFFC804)),
                                                  value: 0.5,
                                                ),
                                              )
                                            ),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: const TextStyle(fontSize: 40.0, fontWeight: FontWeight.normal, color: Color(0xFF333333), letterSpacing: -0.5),
                                          ),
                                        ),
                                        RatingBarIndicator(
                                          rating: widget.rating,
                            ...
                            Padding(
                              ...
                              child: Center(
                                child: TextButton.icon(
                                  ...
                                  label: const Text("Write my review", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.normal, color: Color(0xFF333333), letterSpacing: -0.5),),
                                ),
                              ),
                            )
                          ],
                    ...
                    children: [
                      ...
                      ChoiceChip(
                        ...
                        avatar: Icon(
                          Icons.share_rounded,
                          size: 14,
                          color: _shareValue ? const Color(0xFFFFFFFF) : const Color(0xFF333333),
                        ),
                      ...
                      SizedBox(
                        ...
                        child: IgnorePointer(
                          child: TabBar(
                            ...
                            tabs: [
                              Tab(child: Container(
                                height: _controller.index == 0 ? 5 : 2,
                                decoration: BoxDecoration(
                                color: _controller.index == 0 ? const Color(0xFFFFC804) : const Color(0xFF333333),
                                borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                              ))),
                              Tab(child: Container(
                                height: _controller.index == 1 ? 5 : 2,
                                decoration: BoxDecoration(
                                color: _controller.index == 1 ? const Color(0xFFFFC804) : const Color(0xFF333333),
                                borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                              ))),
                              Tab(child: Container(
                                height: _controller.index == 2 ? 5 : 2,
                                decoration: BoxDecoration(
                                color: _controller.index == 2 ? const Color(0xFFFFC804) : const Color(0xFF333333),
                                borderRadius: const BorderRadius.all(Radius.circular(5.0)),
                              ))),
                            ]
                          ),
          ...
          Positioned(
            ...
            child: Center(
              child: Marquee(
                child: Text(widget.shopName, style: Theme.of(context).textTheme.headline1),
