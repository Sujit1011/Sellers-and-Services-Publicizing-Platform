    ...
    return Scaffold(
      body: AnnotatedRegion<SystemUiOverlayStyle>(
        value: const SystemUiOverlayStyle(
          ...
          statusBarColor: design.secondaryColor, // status bar color
