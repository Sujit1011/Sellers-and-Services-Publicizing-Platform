...
class ShopProfilePage extends StatefulWidget {
  ...
  const ShopProfilePage({Key? key, required this.rating, required this.shopName, required this.joined, required this.reviews, required this.contacted, required this.aboutUs}) : super(key: key);
                                ...
                                //   height: 200,
                                  children: [
                                    Row(
                                      children: [
                                        const Spacer(),
                                        Expanded(flex: 3, child: Text("Product 1", style: Theme.of(context).textTheme.headline5)),
                                        const Spacer(),
