              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("My Favourite Shops", style: Theme.of(context).textTheme.titleMedium),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("My Favourites Services", style: Theme.of(context).textTheme.titleMedium),
                  ),
